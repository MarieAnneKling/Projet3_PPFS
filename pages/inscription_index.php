      ...
      <section>
        <div id="formulaire">
            <h2>Inscrivez-vous à l'extranet GBAF</h2><br/>           
              ...
              <!--balise <form> pour indiquer qu'il s'agit d'un formulaire, méthod "post" car ne passe pas par l'URL mais est récupérée par le formulaire
              et l'attribut "action" pour indiquer la page appelée par le formulaire-->
              <form action="..\processus\Inscription_cible.php" method="post">
               ...
               et placeholder pour le texte à l'intérieur du champ du formulaire - name va correspondre au name du fichier de traitement-->
                ...
                <!-- cliquer sur ce bouton permettra l'envoi des données du formulaire vers le serveur-->
